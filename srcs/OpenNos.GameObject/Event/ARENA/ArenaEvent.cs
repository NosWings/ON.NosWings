...
namespace OpenNos.GameObject.Event.ARENA
{
    internal class ArenaEvent
    {
        internal static void GenerateTalentArena()
        {
            ...
            {
                ServerManager.Instance.ArenaMembers.Where(s => s.ArenaType == EventType.TALENTARENA).ToList().ForEach(
                    s =>
                    {
                        s.Time -= 1;
                        ...
                        if (s.Time > 0)
                        {
                            if (s.GroupId == null)
                            {
...

                                {
                                    ...
                                    ServerManager.Instance.ArenaMembers.Where(e =>
                                        ...
                                        .ForEach(o =>
                                        {
                                            ...
                                            {
                                                s.Time = 300;
                                                if (ServerManager.Instance.ArenaMembers.Count(g =>
                                                        g.GroupId == s.GroupId) <
                                                    3)
                                                {
                                                    o.Session.SendPacket(
                                                        o.Session.Character.GenerateBsInfo(0, 2, s.Time, 8));
                                                    o.Session.SendPacket(o.Session.Character.GenerateSay(
                                                ...
                                                {
                                                    o.Session.SendPacket(
                                                        o.Session.Character.GenerateBsInfo(0, 2, s.Time, 1));
                                                    o.Session.SendPacket(o.Session.Character.GenerateSay(
                                                        Language.Instance.GetMessageFromKey("SEARCH_RIVAL_ARENA_TEAM"),
                                                        10));
                                                }
                                            });
                                        });
                            ...
                            else
                            {
                                ...
                                ArenaMember member =
                                    ServerManager.Instance.ArenaMembers.FirstOrDefault(o =>
                                ...
                                MapInstance map = ServerManager.Instance.GenerateMapInstance(2015,
                                ...
                                ArenaMember[] arenamembers = ServerManager.Instance.ArenaMembers
                                ...
                                IDisposable obs5 = Observable.Interval(TimeSpan.FromMilliseconds(500)).Subscribe(
                                    start3 =>
                                    {
                                        map.Broadcast(arenamembers.FirstOrDefault(o => o.Session != null)?.Session
                                            .Character.GenerateTaPs());
                                        List<ArenaTeamMember> erenia = arenaTeam
                                            .Where(team => team.ArenaTeamType == ArenaTeamType.ERENIA).ToList();
                                        List<ArenaTeamMember> zenas = arenaTeam
                                            .Where(team => team.ArenaTeamType == ArenaTeamType.ZENAS).ToList();
                                        BuffTeam(erenia);
                                        BuffTeam(zenas);
                                    });
                                arenamembers.ToList().ForEach(o =>
                                {
                                    ...
                                    Observable.Timer(TimeSpan.FromSeconds(1)).Subscribe(time =>
                                    {
                                        ...
                                        Observable.Timer(TimeSpan.FromSeconds(5)).Subscribe(time2 =>
                                        {
                                            ...
                                            o.Session.SendPacket(UserInterfaceHelper.Instance.GenerateMsg(
                                                Language.Instance.GetMessageFromKey("SELECT_ORDER_ARENA_TIME"), 0));
                                            o.Session.SendPacket(o.Session.Character.GenerateSay(
                                                Language.Instance.GetMessageFromKey("SELECT_ORDER_ARENA_TIME"), 10));
                                            o.Session.SendPacket(o.Session.Character.GenerateSay(
                                            ...
                                            obs2 = Observable.Interval(TimeSpan.FromMilliseconds(100)).Subscribe(
                                                start3 =>
                                                {
                                                    ...
                                                    map.MapDesignObjects.ToList().ForEach(e =>
                                                    {
                                                        ...
                                                        {
                                                            Character chara = map
                                                                .GetCharactersInRange(e.MapX, e.MapY, 0)
                                                                .FirstOrDefault();
                                                            if (chara != null)
                                                            {
                                                                resettap = true;
                                                                ArenaTeamMember teammember =
                                                                    arenaTeam.FirstOrDefault(at =>
                                                        ...
                                                        else if (e.ItemInstance.Design == 4436)
                                                        {
                                                            ...
                                                            {
                                                                resettap = true;
                                                                ArenaTeamMember teammember = arenaTeam.FirstOrDefault(
                                                                    at =>
                                                                        at.Order == (e.ItemInstance.ItemVNum - 4433) &&
                                                                        at.ArenaTeamType ==
                                                                        (e.MapX == 120
                                                    ...
                                                    if (resettap)
                                                    {
                                                        arenaTeam.ToList().ForEach(arenauser =>
                                                        {
                                                            arenauser.Session.SendPacket(
                                                                arenauser.Session.Character.GenerateTaP(2, false));
                                                        });
                                                    }
                                                });

                                            Observable.Timer(
                                                    TimeSpan.FromSeconds(map.InstanceBag.Clock.BasesSecondRemaining))
                                                .Subscribe(start =>
                                                {
                                                    obs2.Dispose();
                                                    arenaTeam.ToList().ForEach(arenauser =>
                                                    ...
                                                    map.MapDesignObjects.ToList().ForEach(md =>
                                                        map.Broadcast(md.GenerateEffect(true)));
                                                    map.MapDesignObjects.Clear();
                                                });
                                        });
                                    });
                                });
                                Observable.Timer(TimeSpan.FromSeconds(map.InstanceBag.Clock.BasesSecondRemaining))
                                    .Subscribe(start =>
                                    {
                                        bool newround1 = true;
                                        bool newround2 = true;
                                        ...
                                        {
                                            int ereniacount = arenaTeam.Count(at =>
                                                at.Dead && at.ArenaTeamType == ArenaTeamType.ERENIA);
                                            int zenascount = arenaTeam.Count(at =>
                                            ...
                                            ArenaTeamMember tm = arenaTeam.OrderBy(tm3 => tm3.Order)
                                                .FirstOrDefault(tm3 =>
                                                    tm3.ArenaTeamType == ArenaTeamType.ERENIA && !tm3.Dead);
                                            ArenaTeamMember tm2 = arenaTeam.OrderBy(tm3 => tm3.Order)
                                                .FirstOrDefault(tm3 =>
                                            ...
                                            map.Sessions.Except(arenaTeam.Select(ss => ss.Session)).ToList().ForEach(
                                                o =>
                                                {
                                            ...
                                            obs6?.Dispose();
                                            obs6 = Observable
                                                .Timer(TimeSpan.FromSeconds(map.InstanceBag.Clock.BasesSecondRemaining))
                                                .Subscribe(start4 =>
                                                {
                                                    if (tm2 != null && tm != null)
                                                    {
                                                        ...
                                                        tm2.Session.SendPacket(
                                                            UserInterfaceHelper.Instance.GenerateTaSt(
                                                                TalentArenaOptionType.Watch));
                                                        arenaTeam
                                                            .Where(friends => friends.ArenaTeamType == tm.ArenaTeamType)
                                                            .ToList().ForEach(friends =>
                                                            {
                                                                friends.Session.SendPacket(friends.Session.Character
                                                                    .GenerateTaFc(0));
                                                            });
                                                    }
                                            ...
                                            else
                                            {
                                                switch (tm)
                                                {
                                                    case null when tm2 == null:
                                                        map.Broadcast(UserInterfaceHelper.Instance.GenerateMsg(
                                                            Language.Instance.GetMessageFromKey("EQUALITY"), 0));
                                                        arenaTeam.ToList().ForEach(arenauser =>
                                                        {
                                                            arenauser.Session.SendPacket(
                                                                arenauser.Session.Character.GenerateSay(
                                                                    Language.Instance.GetMessageFromKey("EQUALITY"),
                                                                    10));
                                                            arenauser.Session.SendPacket(arenauser.Session.Character
                                                                .GenerateTaF(3));
                                                        });
                                                        map.Sessions.Except(arenamembers.Select(x => x.Session))
                                                            .ToList().ForEach(
                                                                x =>
                                                                {
                                                                    ArenaTeamMember arenauser =
                                                    ...
                                                    case null:
                                                        map.Broadcast(UserInterfaceHelper.Instance.GenerateMsg(
                                                            Language.Instance.GetMessageFromKey("VICTORIOUS_ZENAS"),
                                                            0));

                                                        arenaTeam.ToList().ForEach(arenauser =>
                                                        {
                                                            SendRewards(arenauser,
                                                                arenauser.ArenaTeamType == ArenaTeamType.ZENAS);
                                                        });
                                                        map.Sessions.Except(arenamembers.Select(x => x.Session))
                                                            .ToList().ForEach(x =>
                                                            {
                                                                ArenaTeamMember arenauser =
                                                                    arenaTeam.FirstOrDefault(se => se.Session != null);
                                                                if (arenauser == null)
                                                                {
                                                                    return;
                                                                }
                                                    ...
                                                    default:
                                                        map.Broadcast(UserInterfaceHelper.Instance.GenerateMsg(
                                                            Language.Instance.GetMessageFromKey("VICTORIOUS_ERENIA"),
                                                            0));
                                                        arenaTeam.ToList().ForEach(arenauser =>
                                                        {
                                                            SendRewards(arenauser,
                                                                arenauser.ArenaTeamType == ArenaTeamType.ERENIA);
                                                        });
                                                        map.Sessions.Except(arenamembers.Select(x => x.Session))
                                                            .ToList().ForEach(
                                                                x =>
                                                ...
                                                Observable.Timer(TimeSpan.FromSeconds(30)).Subscribe(start4 =>
                                                {
                                                    ...
                                                    {
                                                        if (o.Session?.CurrentMapInstance?.MapInstanceType ==
                                                            MapInstanceType.TalentArenaMapInstance)
                                                        {
                                                            ServerManager.Instance.TeleportOnRandomPlaceInMap(o.Session,
        ...
        private static void SendRewards(ArenaTeamMember member, bool win)
        {
            ...
            if (win)
            {
                member.Session.SendPacket(member.ArenaTeamType == ArenaTeamType.ERENIA
                    ...
                    : member.Session.Character.GenerateSay(Language.Instance.GetMessageFromKey("VICTORIOUS_ZENAS"),
                        10));
            }
            else
            {
